...
class TestOperationalLimits(unittest.TestCase):
    def test_left_limits_use_controller_readback_and_physical_j7_cap(self):
        self.assertEqual(ss.LIMITS_DEG[1], [
            (-166.0, 166.0), (-10.0, 208.0), (-166.0, 166.0),
            (-128.0, 103.0), (-166.0, 166.0), (-40.0, 40.0),
            (-88.0, 76.0)])

    def test_controller_readback_cannot_widen_physical_j7_cap(self):
        controller = [(-166, 166), (-10, 208), (-166, 166), (-128, 103),
                      (-166, 166), (-40, 40), (-88, 88)]
        effective = ss.intersect_axis_limits(controller, ss.LIMITS_DEG[1])
        self.assertEqual(effective[6], (-88.0, 76.0))
