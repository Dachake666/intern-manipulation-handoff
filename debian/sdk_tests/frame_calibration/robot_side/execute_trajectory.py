...
# ---------------------------------------------------------------- 配置
ROBOT_IP = "192.168.8.147"     # 2026-07-17 真机 IP 变更 .147->.148(随容器侧同步)
LOCAL_IP = "192.168.8.185"
ARM_IP = "192.168.8.147"
ARM_PORT = 8080

ARM_ID = 1                     # 1=左臂(轨迹 meta.arm_id 必须一致)
GLOBAL_SPEED = 20.0              # 全局速度百分比; 新类型轨迹首跑用 3, 稳了再加
ENABLE_REAL_MOTION = True     # False=干跑; True=真实运动+真实夹爪(Mac 源码永远保持 False)
...
GRIPPER_ACT_WAIT_S = {"close": 2.0, "open": 2.0}   # close 等待与 PDF 示例一致
